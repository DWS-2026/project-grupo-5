...
public class UserManager {
    ...
    @GetMapping("/user/{id}")
    public String getUser(Model model, @PathVariable long id, HttpServletRequest request) {
    ...
    public String postMethodName(Model model, @RequestParam MultipartFile image, @PathVariable long id, HttpServletRequest request) {
    ...
    public String postMethodName(Model model, @RequestParam String userName, @RequestParam String email, @PathVariable long id, HttpServletRequest request) {
