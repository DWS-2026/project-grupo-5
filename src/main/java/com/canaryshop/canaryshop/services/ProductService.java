...
public class ProductService {
    ...
    // Adds a product to the database, throws HTTP error if the product given is
    // invalid
    ...
    // Gets products in a page filtered by name or description, or all products if
    // either are null
    ...
    // Deletes all intermediate OrderProduct entities associated with the product,
    ...
    // Edits the product and adds it to the database, throws HTTP error if the
    // modified product is invalid
    ...
    // Gets reported products in a page by name or description, or all reported
    // products if either are null
